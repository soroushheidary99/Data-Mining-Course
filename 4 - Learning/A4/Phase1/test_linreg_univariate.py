...
if __name__ == "__main__":
    ...
    '''
    init_theta = np.matrix(np.ones((d+1,1)))*1 # note that we really should be initializing this to be near zero, but starting it near [10,10] works better to visualize gradient descent for this particular problem
    n_iter = 100 
    alpha = 0.01 
